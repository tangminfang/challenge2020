...
acc_oval, f_oval, Fbeta_oval, Gbeta_oval=evaluate_score(lb_v, pred,class_num)
print('acc:',acc_oval)
print('f:',f_oval)
print('Fbeta:',Fbeta_oval)
print('Gbeta:',Gbeta_oval)
F1s_val = []
...
acc_rawval, f_rawval, Fbeta_rawval, Gbeta_rawval=evaluate_score(lb_v_raw, pred_raw,class_num)
print('acc:',acc_rawval)
print('f:',f_rawval)
print('Fbeta:',Fbeta_rawval)
print('Gbeta:',Gbeta_rawval)
F1s_val_raw = []
...
print('\nResult for test_set:--------------------\n')
acc_test, f_test, Fbeta_test, Gbeta_test=evaluate_score(lb_t, pred,class_num)
print('acc:',acc_test)
print('f:',f_test)
print('Fbeta:',Fbeta_test)
print('Gbeta:',Gbeta_test)
F1s_test = []
