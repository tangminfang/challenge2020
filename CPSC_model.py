...
class Net2(object):
    ...
    def __cnnblock(inp, C=0.001, stridenum=1, initial='he_normal', poolnum=24):
        net = Conv1D(12, 3,strides=stridenum, padding='same', kernel_initializer=initial, kernel_regularizer=regularizers.l2(C))(inp)
        net = LeakyReLU(0.2)(net)
        net = Conv1D(12, 3, strides=stridenum, padding='same', kernel_initializer=initial,
